...
<head>
  ...
  <!-- Favicons -->
  <link href="img/new_pict/favicon.png" rel="icon">
        ...
        <ul>
          ...
          <li class="drop-down"><a href="">Plus</a>
            <ul>
              ...
              <li><a href="#">Condtions Générale de Vente</a></li>
    ...
    <div class="container d-flex h-100">
      <div class="row justify-content-center align-self-center">
        <div class="col-md-6 intro-info order-md-first order-last">
          <h2>Solutions rapides <br>Pour votre <span>Business!</span></h2>
          <div>
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-6">
            <div class="about-content">
              <h2>A propos</h2>
              <h3>Une fine équipe d'étudiants entreprenant de l'école 19</h3>
              <p>Nous sommes des étudiants de l'école 19 (école d'informatique 42 Belgique) ayant envie de nous investir dans un projet commun afin d'allier nos compétences.</p>
              <p>La mise en pratique de nos connaissances est l'une des choses les plus importantes à nos yeux. C'est pour cela, qu'ensemble, nous souhaitons faire des projets qui touchent à plusieurs domaines de l'informatique. Cela nous permettra d'acquérir des compétences au delà des formations accessibles.</p>
              <p>Nous pouvons (ou souhaitons apprendre à) créer:</p>
              <ul>
                <li><i class="ion-android-checkmark-circle"></i> Des sites internet (vitrine ou dynamique).</li>
                <li><i class="ion-android-checkmark-circle"></i> Des applications téléphone utilisant des API.</li>
                <li><i class="ion-android-checkmark-circle"></i> Des bots discord reliés à un site internet.</li>
                <li><i class="ion-android-checkmark-circle"></i> Du design de site internet</li>
                <li><i class="ion-android-checkmark-circle"></i> Des scripts de gestion de données</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              ...
              <h4 class="title"><a href="">Croissance de projet</a></h4>
              <p class="description">Nous ne somme peut-être pas experts, mais nous pouvons apporter une aide à la croissance de votre projet.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              ...
              <p class="description">Nous pouvons vous aider à gérer des données et vous les structurer pour une utilisation prochaine.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="box">
              ...
              <h4 class="title"><a href="">Référencement</a></h4>
              <p class="description">Si vous souhaitez être visible sur les moteurs de recherche, nous pouvons améliorer le référencement de votre site.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon" style="background: #eafde7;"><i class="ion-ios-speedometer-outline" style="color:#41cf2e;"></i></div>
              <h4 class="title"><a href="">Performance d'ordinateur</a></h4>
              <p class="description">Si un ordinateur devient lent nous pouvons vérifier ses composants et vous avertir s'ils doivent être changés.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.2s" data-wow-duration="1.4s">
            <div class="box">
              ...
              <h4 class="title"><a href="">Site internet</a></h4>
              <p class="description">Nous pouvons vous créer un site internet statique ou dynamique qui vous aidera à vous faire connaitre !</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.2s" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon" style="background: #ecebff;"><i class="ion-ios-clock-outline" style="color: #8660fe;"></i></div>
              <h4 class="title"><a href="">Formation rapide</a></h4>
              <p class="description">Nous pouvons initier des débutants à différents langages de programmation pour qu'ils puissent créer leur projet.</p>
            </div>
          </div>
    ...
    <section id="why-us" class="wow fadeIn">
      <div class="container-fluid">
        ...
        <header class="section-header">
          ...
          <p>Notre équipe n'est peut-être pas la meilleure mais elle le deviendra très vite ! De plus, nous avons la capacité d'apprendre et de nous adapter rapidement grâce à notre formation à <a href="https://www.s19.be/" target=_blank>l'école 19.</a></p>
        </header>
          ...
          <div class="col-lg-6">
            <div class="why-us-content">
              ...
              <div class="features wow bounceInUp clearfix">
                ...
                <h4>Un projet sur mesure suivant vos attentes</h4>
                <p>Etant de simples étudiants nous devons nous assurer que nos client soient satisfaits de notre travail, c'est pour cela que tout le long de votre projet nous serons là pour vous et pour retravailler sur des parties que vous voudriez modifier</p>
              </div>
              
              <div class="features wow bounceInUp clearfix">
                <i class="fa fa-language" style="color: #589af1;"></i>
                <h4>Contribution à la jeunesse</h4>
                <p>En coopérant avec nous pour un projet vous contribuez à former de façon professionnelle de nouveaux développeurs, ce qui nous permettra de pouvoir réussir des projets de plus en plus complexes</p>
              </div>
    ...
    <section id="portfolio" class="section-bg">
      <div class="container">
        ...
        <header class="section-header">
          <h3 class="section-title">Notre portfolio</h3>
        </header>
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-card">Montage</li>
              <li data-filter=".filter-web">Site internet</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container">
          ...
          <!-- filtre différent: filter-app (filtre pour les applications) filter-web (filtre pour les sites internets) filter-card (Filtre pour les montage) -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp">
            <div class="member">
              <img src="img/new_pict/escarrie.png" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Esteban Carrière</h4>
                  ...
                  <div class="social">
                    ...
                    -->
                    <a href="https://www.linkedin.com/in/esteban-carri%C3%A8re-0655a8191/" target="_blank"><i class="fa fa-linkedin"></i></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-block">
                ...
                <ul class="list-group">
                  ...
                  <li class="list-group-item">Projet prioritaire</li>
                  <li class="list-group-item">Réduction futur de 30%</li>
                  <li class="list-group-item">Support de 8h30 à 19h</li>
                </ul>
                <a href="#" class="btn">Reserver</a>
              </div>
            </div>
          ...
          <div class="col-xs-12 col-lg-4">
            <div class="card">
              ...
              <div class="card-block">
                ...
                <ul class="list-group">
                  <li class="list-group-item">Suivis de votre demande</li>
                  <li class="list-group-item">Réduction de 15%</li>
                  <li class="list-group-item"></li>
                  <li class="list-group-item">Support de 8h30 à 12h</li>
                </ul>
                <a href="#" class="btn">Reserver</a>
              </div>
            </div>
    ...
    <section id="faq">
      <div class="container">
        <header class="section-header">
          ...
          <p>Si les réponses déjà envoyer à des clients ne vous conviennent pas ou ne sont pas assez clair <a style="text-decoration: none;" href="#footer" id="to_contact">contacter nous</a>!</p>
        </header>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="footer-links">
                    <h4>Liens utiles</h4>
                    <ul>
                      <li><a id="to_acc" href="#intro">Accueil</a></li>
                      <li><a href="#about">A propos</a></li>
                      <li><a href="#services">Services</a></li>
                      <li><a href="#">Condition générales de vente</a></li>
                      <li><a href="#">Politique de confidentialité</a></li>
                    </ul>
                  </div>
                    ...
                    <p>
                      ...
                      <span id="tel_support">
                        <script>
                          ...
                          if (Hour > 8 && Hour < 11)
                            document.getElementById("tel_support").innerHTML = "+32 498.79.78.86";
                          else if (Hour >= 11 && Hour < 14)
                            document.getElementById("tel_support").innerHTML = "+32 486.81.76.43";
                          else if (Hour >= 14 && Hour < 17)
                            document.getElementById("tel_support").innerHTML = "+32 493.87.15.35";
                          else if (Hour >= 17 && Hour < 19)
                            document.getElementById("tel_support").innerHTML = "+32 486.34.84.99";
                          else
                            document.getElementById("tel_support").innerHTML = "Pas ouvert";
                        </script>
                      </span>
                      <br>
          ...
          <div class="col-lg-6">
            ...
            <div class="form">
              ...
              <form action="php/formContact.php" method="post" role="form" class="contactForm" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                  <input type="email" class="form-control" name="email" id="email" placeholder="Votre email" data-rule="email" data-msg="Entrer une adresse email valide" />
                  <div class="validation"></div>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="subject" id="subject" placeholder="Sujet" data-rule="minlen:4" data-msg="Le sujet doit contenir 8 caracteres" />
                  <div class="validation"></div>
                </div>
                <div class="form-group">
                ...
                <div id="sendmessage">Votre message à bien été envoyer, Merci!</div>
